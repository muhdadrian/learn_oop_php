...
class Product {
	...
	//1. we make method for title to access it even the property title above is private
	//getTitle below is getter
...
$product1->title = "NewTitle";//2. this will not change the title as the title is private (cannot be accessed)
//to change the title we need setter method. Go to 44
