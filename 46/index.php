...
class Product {
	...
	private	$discount = 0;//why protected as it's only in class Game 
	//to make the discount more flexible, put it in class Product. Go to 47 where we remove the discount in game to product 
	...
	//1. we have to make another function for the private property above
