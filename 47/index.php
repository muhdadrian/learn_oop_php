...
class Product {
	...
	private $title, 
				  ...
				  $publisher,
					$price,
					$discount;//2. we make this private from protected.
	...
	//1. we remove from game to product for the discount method
	public function setDiscount($discount){
		$this->discount = $discount;
	}

	//3. we make getter for discount
...
echo $product1->getTitle();//to know its title
echo "<br>";
echo $product1->getAuthor();//to know its author
//to replace the author go to 48
