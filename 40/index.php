...
class Product {
	public $title, 
				 $author,
				 $publisher;
	private	$discount = 0;//if we use private. The discount will not work, as in class Game, the setDiscount property cannot be accessed. It can only be accessed in class Product. So change it back to protected so that the discount is working.
